...
WallBot::WallBot(char *name, GameServer *server, int key): ClientBot(name,server,key)
{
	SetupTextures();
}
...
void WallBot::SetupTextures(void)
{
...
char * WallBot::GetBotTexture(void)
{
	return m_bot;
}

char * WallBot::GetWeaponTexture(void)
{
	return m_weapon;
}

Maths::Vector WallBot::GetBotSize(void)
{
	return m_size;
}

Maths::Vector WallBot::GetBotAxis(void)
{
	return m_axis;
}
