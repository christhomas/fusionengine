...
#include <OpenGL/OGLDynamicVB.h>
#include <OpenGL/OGLImageTexture.h>
#include <OpenGL/OGLProceduralTexture.h>
...
bool OGLGraphics::Enable(int flag, int options)
{
	switch(flag){
		...
		case IGraphics::MODE2D:{
			...
			glBlendFunc(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);	//	Enable cutout type transparency
