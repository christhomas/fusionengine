...
typedef std::vector<Entity *>			ENTITYLIST;		//	Defines a list of entitys which defines a group
typedef std::vector<ENTITYLIST>		GROUPLIST;		//	Defines a list of groups the system handles
typedef std::vector<int>			COMPARELIST;	//	Defines a list of pair of groups to cd each other
typedef std::vector<CollisionPair *>	COLLISIONPAIR;	//	Defines a list of entitys which has collided

//	Base collision system
class Collision{
protected:
	GROUPLIST		m_groups;
	COMPARELIST		m_comparegroups;
