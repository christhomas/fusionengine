 ...
 */
void MeshDB::DeleteMesh(unsigned int index)
{
 ...
 *	@param index	The index of the mesh to delete
 */
void MeshDB::DeleteOverlay(unsigned int index)
{
 ...
 */
Mesh * MeshDB::GetMeshPtr(unsigned int index)
{
 ...
 */
Overlay * MeshDB::GetOverlayPtr(unsigned int index)
{
