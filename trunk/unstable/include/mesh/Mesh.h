 ...
 */
struct TempPolygon{
	unsigned int numvertex;	/**<	The number of vertices in this polygon */
	unsigned int *index;	/**<	An array of vertex indices */
};
