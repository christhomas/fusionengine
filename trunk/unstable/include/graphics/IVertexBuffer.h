...
public:
	...
	virtual bool Initialise(unsigned int nv, unsigned int ni, unsigned int nc_p, unsigned int nc_t) = 0;
	...
	virtual	void SetComponents(unsigned int p, unsigned int t) = 0;
	...
	virtual void SetTextureLayer(unsigned int layer, float *tc, ITexture *t) = 0;
	...
	virtual float *	GetTexcoord(unsigned layer=0) = 0;
	
	/** Retrieves the index data */
	virtual unsigned int * GetIndex(void) = 0;
	
	/** Retrieves the texture map */
	virtual ITexture * GetTexture(unsigned int layer=0) = 0;
	...
	virtual unsigned int GetNumIndex(void) = 0;
